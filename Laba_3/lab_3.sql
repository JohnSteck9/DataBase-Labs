...
ALTER TABLE pizza_has_order_info
	ADD CONSTRAINT FK_pizza_id
		...
		REFERENCES pizza (id),
	ADD CONSTRAINT FK_order_info_id_pazza
		FOREIGN KEY (order_info_id)
		REFERENCES order_info (id);
...
insert into order_status (id, name) values (1, 'Violet');
insert into order_status (id, name) values (2, 'Fuscia');
insert into order_status (id, name) values (3, 'Mauv');
insert into order_status (id, name) values (4, 'Teal');
insert into order_status (id, name) values (5, 'Green');
insert into order_status (id, name) values (6, 'Turquoise');
insert into order_status (id, name) values (7, 'Turquoise');
insert into order_status (id, name) values (8, 'Green');
insert into order_status (id, name) values (9, 'Puce');
insert into order_status (id, name) values (10, 'Green');
...
insert into courier (id, first_name, last_name, phone, email, courier_status_id) values (9, 'Curcio', 'D''Ambrogi', '304-931-4618', 'cdambrogi8@macromedia.com', 9);
insert into courier (id, first_name, last_name, phone, email, courier_status_id) values (10, 'Tarah', 'Slott', '497-915-4406', 'tslott9@bbc.co.uk', 10);

insert into order_info (id, additional_info, price_product, prise_delivery, prise_total, expected_time, actual_time, delivery_area_id, order_status_id, customer_id, courier_id) values (1, 'Uraeginthus granatina', 360, 93, 453, '4:08', '22:53', 1, 1, 1, 1);
insert into order_info (id, additional_info, price_product, prise_delivery, prise_total, expected_time, actual_time, delivery_area_id, order_status_id, customer_id, courier_id) values (2, 'Bubulcus ibis', 964, 12, 976, '10:09', '1:11', 2, 2, 2, 2);
insert into order_info (id, additional_info, price_product, prise_delivery, prise_total, expected_time, actual_time, delivery_area_id, order_status_id, customer_id, courier_id) values (3, 'Eumetopias jubatus', 1913, 60, 1973, '7:41', '22:12', 3, 3, 3, 3);
insert into order_info (id, additional_info, price_product, prise_delivery, prise_total, expected_time, actual_time, delivery_area_id, order_status_id, customer_id, courier_id) values (4, 'Thamnolaea cinnmomeiventris', 2632, 84, 2716, '23:10', '7:28', 4, 4, 4, 4);
insert into order_info (id, additional_info, price_product, prise_delivery, prise_total, expected_time, actual_time, delivery_area_id, order_status_id, customer_id, courier_id) values (5, 'Neophron percnopterus', 326, 31, 357, '16:26', '10:13', 5, 5, 5, 5);
insert into order_info (id, additional_info, price_product, prise_delivery, prise_total, expected_time, actual_time, delivery_area_id, order_status_id, customer_id, courier_id) values (6, 'Bison bison', 1654, 68, 1722, '19:47', '16:02', 6, 6, 6, 6);
insert into order_info (id, additional_info, price_product, prise_delivery, prise_total, expected_time, actual_time, delivery_area_id, order_status_id, customer_id, courier_id) values (7, 'Phasianus colchicus', 1733, 72, 1805, '22:48', '17:13', 7, 7, 7, 7);
...
insert into pizza_additions_has_pizza_has_order_info (pizza_additions_id, pizza_has_order_info_pizza_id, pizza_has_order_info_order_info_id) values (8, 8, 8);
